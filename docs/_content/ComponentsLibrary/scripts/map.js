let showOrUpdate = (elementId, zoom, markers) => {
    ...
    if (!elem.map) {
        ...
        L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibHdpbmNoMjAwNiIsImEiOiJjbDIzZzFyYzQwMWthM2Rwc3hsaGV1emNzIn0.gUUiTsDEXJlqERWl-V8v1A', {
            attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
            maxZoom: 18,
            id: 'mapbox/streets-v11',
            tileSize: 512,
            zoomOffset: -1,
            accessToken: 'pk.eyJ1IjoibHdpbmNoMjAwNiIsImEiOiJjbDIzZzFyYzQwMWthM2Rwc3hsaGV1emNzIn0.gUUiTsDEXJlqERWl-V8v1A'
        }).addTo(elem.map);
    }
    ...
    if (map.addedMarkers.length !== markers.length) {
        ...
        markers.forEach((marker, index) => {
            animateMarkerMove(map.addedMarkers[index].setPopupContent(marker.description), marker, 4000);
        });
    }
}
