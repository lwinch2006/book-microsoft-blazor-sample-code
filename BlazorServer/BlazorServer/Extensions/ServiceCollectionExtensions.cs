		...
		services
			.Add(() => services
				...
				.AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
				{
					...
					options.Scope.Add("blazor-book-hosted-app-api.read");
			...
			.Add(() => services.AddAccessTokenManagement())
			.Add(() => services.AddUserAccessTokenHttpClient(nameof(WeatherForecastService), null, httpClient =>
			{
